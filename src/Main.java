...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        int page = 13;
        int noOfCards;
        wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.cssSelector(linkCSS), 0));
        List<WebElement> cards = driver.findElements(By.cssSelector(linkCSS));
        ...
        for (int i = 0; i < page; i++) {
            ...
            wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.cssSelector(linkCSS), noOfCards));
            prevNoOfCards = noOfCards;
            cards = driver.findElements(By.cssSelector(linkCSS));
            noOfCards = cards.size();
        }
    }
}